		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lov Data",
									"targetURL": "#lovdatafioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lovdatafioriapp-display": {
								"semanticObject": "lovdatafioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lovdatafioriapp",
									"url": sap.ui.require.toUrl("lovdatafioriapp")
								}
							}
						}
					}
